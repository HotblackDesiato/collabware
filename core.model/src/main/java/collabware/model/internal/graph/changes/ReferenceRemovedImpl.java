...
public class ReferenceRemovedImpl implements ReferenceRemoved {
	...
	public ReferenceRemovedImpl(String nodeId, String reference, String targetId, int position) {
		this.nodeId = nodeId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReferenceRemovedImpl other = (ReferenceRemovedImpl) obj;
		if (nodeId == null) {
