define(["ideawall/framework/Controller",  "ideawall/commands/ChangeUserStoryName", "ideawall/mixins/Editable", "ideawall/mixins/Movable", "ideawall/presenters/Utils"], 
		function (Controller, ChangeUserStoryName, Editable, Movable, Utils) {
	
	Utils.loadCss("ideawall/presenters/UserStory.css");
